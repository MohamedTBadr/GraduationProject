...
namespace Application.Interfaces
{
    ...
    {
        Task<Result<UserResponse>> LogIn(LoginRequest loginRequest, CancellationToken cancellationToken);

        Task<Result<UserResponse>> RegisterAsync(SignUpRequest request, CancellationToken cancellationToken);
        ...
        Task<Result<UserResponse>> RefreshTokenAsync(RefreshTokenRequest request, CancellationToken cancellationToken);
